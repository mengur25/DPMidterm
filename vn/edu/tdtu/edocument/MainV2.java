...
public class MainV2 {
        public static void main(String[] args) {
                ...
                // Tạo các file giả lập để phục vụ demo
                try {
                        // Tạo thư mục riêng để chứa file demo
                        String folderPath = "demo_files";
                        ...
                        String[] demoFiles = {
                                        "dummy_path.pdf",
                                        "invoice.png",
                                        "tailieu_virus_trojan.pdf",
                                        "don_xin_hoc.pdf",
                                        "phan_mem.exe"
                        };

                        for (String fileName : demoFiles) {
                                String fullPath = folderPath + "/" + fileName;

                                java.io.FileWriter fw = new java.io.FileWriter(fullPath);
                                fw.write("fake file for demo: " + fileName);
                                fw.close();
                        }

                        System.out.println("\n[SETUP] Đã tạo các file giả lập trong thư mục: " + folderPath);
                ...
                try {
                        java.io.FileWriter fw = new java.io.FileWriter("demo_files/dummy_path.pdf");
                        fw.write("Day la noi dung file dummy PDF.");
                        fw.close();
                } catch (Exception e) {
                }

                builder.withFileInfo("demo_files/dummy_path.pdf", "pdf", 1024)
                ...
                Document imgDoc = new Document.Builder()
                                ...
                                .withFileInfo("demo_files/invoice.png", "png", 2048)
                ...
                Document docFailStation1 = new Document.Builder()
                                ...
                                .withDocumentType("DON_XIN_PHEP")
                                .withFileInfo("demo_files/phan_mem.exe", "exe", 500) // file .exe
                ...
                Document docFailStation2 = new Document.Builder()
                                ...
                                .withOfficerInfo("Can Bo B", "cbb@tdtu.edu.vn", "098")
                                .withDocumentType("DON_XIN_PHEP")
                                .withFileInfo("demo_files/tailieu_virus_trojan.pdf", "pdf", 1024) // Tên file có chữ
                                                                                                  // "virus"
                ...
                Document docFailStation3 = new Document.Builder()
                                ...
                                .withOfficerInfo("Can Bo B", "cbb@tdtu.edu.vn", "098")
                                .withDocumentType("DON_XIN_PHEP")
                                .withFileInfo("demo_files/don_xin_hoc.pdf", "pdf", 2048)
